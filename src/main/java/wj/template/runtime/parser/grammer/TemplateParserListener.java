...
public interface TemplateParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code expression_constant}
	 * labeled alternative in {@link TemplateParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterExpression_constant(TemplateParser.Expression_constantContext ctx);
	/**
	 * Exit a parse tree produced by the {@code expression_constant}
	 * labeled alternative in {@link TemplateParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExpression_constant(TemplateParser.Expression_constantContext ctx);
	/**
